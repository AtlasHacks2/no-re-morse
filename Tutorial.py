...
class tutorial:
    def __init__(self):
        ...
        # CREATES LABEL FOR HYPERLINK
        link1 = Label(self.learn, text="Morse Code Sound Effects(2 minute video)",font=('Helvetica bold', 15), fg="blue", cursor="hand2")
        link1.pack()
        link1.bind("<Button-1>", lambda e: callback("https://www.youtube.com/watch?v=GFUHBV8Yn8E"))
        # CREATES LABEL FOR HYPERLINK
        link1 = Label(self.learn, text="How I learned MORSE CODE IN 10 MINUTES | learn fast(3 minute video)", font=('Helvetica bold', 15), fg="blue", cursor="hand2")
        link1.pack()
